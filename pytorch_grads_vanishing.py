...
for activation in (torch.nn.ELU,torch.nn.Hardtanh,torch.nn.LeakyReLU,torch.nn.LogSigmoid,torch.nn.PReLU,torch.nn.ReLU,torch.nn.ReLU6,torch.nn.RReLU,torch.nn.SELU,torch.nn.CELU,torch.nn.Sigmoid,torch.nn.Softplus,torch.nn.Softshrink,torch.nn.Softsign,torch.nn.Tanh,torch.nn.Tanhshrink,torch.nn.Hardshrink):
    ...
    print(activation, np.mean(fc1_grads))
